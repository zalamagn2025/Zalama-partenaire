    ...
    <div className="p-6 space-y-6 max-w-full overflow-hidden">
      ...
      <div className="bg-[var(--zalama-card)] border border-[var(--zalama-border)] border-opacity-20 rounded-lg shadow p-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold flex items-center gap-2" style={{ color: "var(--zalama-orange)" }}>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{
                background: showFilters ? "var(--zalama-orange)" : "var(--zalama-bg-lighter)",
                color: showFilters ? "white" : "var(--zalama-text)"
              }}
            >
