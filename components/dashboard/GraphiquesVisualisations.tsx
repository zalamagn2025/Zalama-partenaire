    ...
    financialData.forEach((transaction) => {
      ...
      if (monthlyStats[monthKey]) {
        if (transaction.type === "Récupéré") {
          monthlyStats[monthKey].remboursements +=
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-sm md:text-base font-medium mb-3 text-[var(--zalama-text)]">
            Courbes d&apos;évolution mensuelle
          </h3>
          <div className="h-64 w-full mt-4">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <XAxis
                  dataKey="name"
                  stroke="var(--zalama-text-secondary)"
                  fontSize={12}
                />
              ...
              >
                ...
                <Bar
                  ...
                  label={{
                    ...
                    fontSize: 12,
                    fill: "var(--zalama-text-secondary)",
                  }}
                />
              </BarChart>
            </ResponsiveContainer>
